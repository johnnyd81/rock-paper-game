...
This app takes inspiration from the classic decision making game of rock paper scissors. The user selects an option and the computer selects an option. Each duel won adds one point to the user's total.
